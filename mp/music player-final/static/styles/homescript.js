...
$(document).ready(function () {
    ...
    socket.on('after connect', function (msg) {
        ...
        // ---------------------------------------------
        document.getElementById('table_h').innerHTML = '';
        var table = document.getElementById("table_h");
        ...
        // ---------------------------------------------
        document.getElementById('table_v').innerHTML = '';
...
function add_v(data, index) {
    console.log('called')
    var table = document.getElementById("table_v");
    var row = table.insertRow(-1);
